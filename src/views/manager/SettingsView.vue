    ...
    <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="card">
          ...
          <div class="space-y-4">
            <AppInput v-model="form.event_name" label="Nome Evento" placeholder="Es. Sagra del Risotto" />
        ...
        <div class="card">
          ...
          <div class="space-y-4">
            <AppInput v-model="form.receipt_header" label="Intestazione" placeholder="Es. Associazione Pro Loco" />
            <AppInput v-model="form.receipt_footer" label="Piè di pagina" placeholder="Es. Grazie e arrivederci!" />
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <AppInput v-model="form.printer_kitchen_ip" label="Stampante Cucina" placeholder="192.168.1.100" />
            <AppInput v-model="form.printer_bar_ip" label="Stampante Bar" placeholder="192.168.1.101" />
          </div>
        </div>
      ...
      <div class="space-y-6">
        ...
        <div class="card">
          ...
          <div class="space-y-4">
            ...
            <div v-if="form.enable_covers">
              <AppInput v-model.number="form.cover_price" type="number" label="Prezzo Coperto (€)" :step="0.10" :min="0" />
            </div>
        ...
        <div class="sticky bottom-6">
          <div v-if="successMessage" class="mb-4 p-4 bg-green-100 text-green-700 rounded-xl text-sm font-bold text-center animate-fade-in">
            {{ successMessage }}
          </div>
