...
<template>
  <div
    class="min-h-screen flex items-center justify-center p-4 bg-gray-50 relative overflow-hidden"
  >
    <!-- Background decoration -->
    <div
      class="absolute inset-0 bg-primary-600 skew-y-6 origin-top-left transform -translate-y-1/2 z-0"
    ></div>
    ...
    <div class="w-full max-w-md z-10">
      ...
      <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
        <div class="p-8 sm:p-12">
          ...
          <div class="text-center mb-10">
            <div
              class="inline-flex items-center justify-center w-20 h-20 bg-primary-50 rounded-2xl mb-6 text-primary-600 shadow-sm transform rotate-3 hover:rotate-6 transition-transform duration-300"
            >
          ...
          <form @submit.prevent="handleSubmit" class="space-y-8 p-2">
            ...
            <div
              ...
              class="rounded-2xl bg-red-50 p-4 text-sm text-red-600 flex items-center border border-red-100 animate-pulse"
            >
              <svg
              ...
              <div class="group">
                <div class="relative">
                  <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg
                      class="h-6 w-6 text-gray-400 group-focus-within:text-primary-500 transition-colors duration-300"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <p
                  v-if="errors.email"
                  class="text-sm text-red-600 mt-2 pl-4 font-medium flex items-center"
                >
        ...
        <div class="px-8 py-6 bg-gray-50 border-t border-gray-100 flex justify-center">
          <router-link
            to="/"
            class="text-sm font-semibold text-primary-600 hover:text-primary-700 flex items-center transition-colors group"
          >
            <svg
      ...
      <div class="mt-8 text-center">
        <div
          class="inline-block px-6 py-3 bg-gray-500/80 backdrop-blur-md rounded-full border border-white/20 shadow-lg text-sm text-white"
        >
          <span class="font-bold opacity-90">Demo:</span> admin@proloco.test
          <span class="mx-2 opacity-50">|</span> password123
        </div>
      </div>
    </div>
  </div>
