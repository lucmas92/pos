        ...
        <div class="form-group">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-2">
            <label
              ...
              :key="allergen.id"
              class="flex items-center p-2 rounded-lg border cursor-pointer transition-colors"
              :class="form.allergens?.includes(allergen.id) ? 'bg-primary-50 border-primary-200' : 'bg-white border-gray-200 hover:bg-gray-50'"
            >
              <input
                type="checkbox"
                :value="allergen.id"
              ...
              />
              <span class="text-lg mr-2">{{ allergen.icon }}</span>
              <span class="text-sm text-gray-700">{{ allergen.label }}</span>
            </label>
          </div>
        </div>
