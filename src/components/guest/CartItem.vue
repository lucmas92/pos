...
<template>
  <div
    class="bg-white border border-gray-100 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow duration-200"
  >
    <div class="flex gap-4">
      ...
      <div
        v-else
        class="w-16 h-16 rounded-lg bg-gray-100 flex items-center justify-center text-gray-400 flex-shrink-0"
      >
      ...
      <div class="flex-1 min-w-0">
        ...
        <p
          v-if="item.notes"
          class="text-xs text-gray-500 mt-1 italic bg-gray-50 p-1.5 rounded-md border border-gray-100"
        >
          Note: {{ item.notes }}
        </p>
